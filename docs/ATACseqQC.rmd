...
rep3 <- readBamFile(bamfile3, tag=tags, which=which, asMates=TRUE)
rep3_shift <- shiftGAlignmentsList(rep3)
shiftedBamfile <- file.path(outPath, "shifted.bam")
export(rep3_shift, shiftedBamfile)
...
objs3 <- splitGAlignmentsByCut(rep3_shift, txs=txs, genome=genome, outPath = outPath,
